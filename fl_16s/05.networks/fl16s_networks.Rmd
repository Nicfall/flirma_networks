...
# SparCC network
#lower keys 1
spar.sid.pre.lk1i <- sparcc(seq.sid.pre.lk1.in.no2); beep()
...
## Visualizing network from adjacency matrix{.tabset}
...
#removed size.min=1 from options
net.sid.pre.lk1i <- ggnet2(adj.sid.pre.lk1i,size=1,alpha=0.5,color="#3BBA76")+
  ggtitle('Inshore pre-disturb.')
#net.sid.pre.lk1i
net.sid.pre.lk1o <- ggnet2(adj.sid.pre.lk1o,size=1,alpha=0.5,color="#453882")+
  ggtitle('Offshore pre-disturb.')
#net.sid.pre.lk1o

ggarrange(net.sid.pre.lk1i,net.sid.pre.lk1o)

net.sid.irm.lk1i <- ggnet2(adj.sid.irm.lk1i,size=1,alpha=0.5,color="#3BBA76")+
  ggtitle('Inshore disturbance')
#net.sid.irm.lk1i
net.sid.irm.lk1o <- ggnet2(adj.sid.irm.lk1o,size=1,alpha=0.5,color="#453882")+
  ggtitle('Offshore disturbance')
#net.sid.irm.lk1o

ggarrange(net.sid.irm.lk1i,net.sid.irm.lk1o)            

net.sid.pos.lk1i <- ggnet2(adj.sid.pos.lk1i,size=1,alpha=0.5,color="#3BBA76")+
  ggtitle('Inshore post-disturb.')
#net.sid.pos.lk1i
net.sid.pos.lk1o <- ggnet2(adj.sid.pos.lk1o,size=1,alpha=0.5,color="#453882")+
...
#removed size.min=1 from options
net.sid.pre.uk1i <- ggnet2(adj.sid.pre.uk1i,size=1,alpha=0.5,color="#3BBA76")+
  ggtitle('Inshore')
#net.sid.pre.uk1i
net.sid.pre.uk1o <- ggnet2(adj.sid.pre.uk1o,size=1,alpha=0.5,color="#453882")+
  ggtitle('Offshore')
#net.sid.pre.uk1o

ggarrange(net.sid.pre.uk1i,net.sid.pre.uk1o)

net.sid.irm.uk1i <- ggnet2(adj.sid.irm.uk1i,size=1,alpha=0.5,color="#3BBA76")+
  ggtitle(' ')
#net.sid.irm.uk1i
net.sid.irm.uk1o <- ggnet2(adj.sid.irm.uk1o,size=1,alpha=0.5,color="#453882")+
  ggtitle(' ')
#net.sid.irm.uk1o

ggarrange(net.sid.irm.uk1i,net.sid.irm.uk1o)            

net.sid.pos.uk1i <- ggnet2(adj.sid.pos.uk1i,size=1,alpha=0.5,color="#3BBA76")+
  ggtitle(' ')
#net.sid.pos.uk1i
net.sid.pos.uk1o <- ggnet2(adj.sid.pos.uk1o,size=1,alpha=0.5,color="#453882")+
  ggtitle(' ')
net.sid.pos.uk1o
...
#removed size.min=1 from options
net.sid.pre.uk2i <- ggnet2(adj.sid.pre.uk2i,size=1,alpha=0.5,color="#3BBA76")+
  ggtitle('Inshore')
#net.sid.pre.uk2i
net.sid.pre.uk2o <- ggnet2(adj.sid.pre.uk2o,size=1,alpha=0.5,color="#453882")+
  ggtitle('Offshore')
#net.sid.pre.uk2o

ggarrange(net.sid.pre.uk2i,net.sid.pre.uk2o)

net.sid.irm.uk2i <- ggnet2(adj.sid.irm.uk2i,size=1,alpha=0.5,color="#3BBA76")+
  ggtitle(' ')
#net.sid.irm.uk2i
net.sid.irm.uk2o <- ggnet2(adj.sid.irm.uk2o,size=1,alpha=0.5,color="#453882")+
  ggtitle(' ')
#net.sid.irm.uk2o

ggarrange(net.sid.irm.uk2i,net.sid.irm.uk2o)            

net.sid.pos.uk2i <- ggnet2(adj.sid.pos.uk2i,size=1,alpha=0.5,color="#3BBA76")+
  ggtitle(' ')
#net.sid.pos.uk2i
net.sid.pos.uk2o <- ggnet2(adj.sid.pos.uk2o,size=1,alpha=0.5,color="#453882")+
  ggtitle(' ')
net.sid.pos.uk2o
...
#removed size.min=1 from options
net.rad.pre.lk1i <- ggnet2(adj.rad.pre.lk1i,size=1,alpha=0.5,color="#3BBA76")+
  ggtitle('Inshore')
#net.rad.pre.lk1i
net.rad.pre.lk1o <- ggnet2(adj.rad.pre.lk1o,size=1,alpha=0.5,color="#453882")+
  ggtitle('Offshore')
#net.rad.pre.lk1o

ggarrange(net.rad.pre.lk1i,net.rad.pre.lk1o)

net.rad.irm.lk1i <- ggnet2(adj.rad.irm.lk1i,size=1,alpha=0.5,color="#3BBA76")+
  ggtitle('Inshore disturbance')
#net.rad.irm.lk1i
net.rad.irm.lk1o <- ggnet2(adj.rad.irm.lk1o,size=1,alpha=0.5,color="#453882")+
  ggtitle('Offshore disturbance')
#net.rad.irm.lk1o

ggarrange(net.rad.irm.lk1i,net.rad.irm.lk1o)            

net.rad.pos.lk1i <- ggnet2(adj.rad.pos.lk1i,size=1,alpha=0.5,color="#3BBA76")+
  ggtitle('Inshore post-disturb.')
#net.rad.pos.lk1i
net.rad.pos.lk1o <- ggnet2(adj.rad.pos.lk1o,size=1,alpha=0.5,color="#453882")+
  ggtitle('Offshore post-disturb.')
#net.rad.pos.lk1o
...
```{r}
gg.net.lk1 <- ggarrange(net.rad.pre.lk1i,net.rad.pre.lk1o,net.rad.irm.lk1i,net.rad.irm.lk1o,net.rad.pos.lk1i,net.rad.pos.lk1o,ncol=2,nrow=3)

annotate_figure(gg.net.lk1,top=text_grob("S. radians - Lower Keys 1",size=16))
```
...
#removed size.min=1 from options
net.rad.pre.uk1i <- ggnet2(adj.rad.pre.uk1i,size=1,alpha=0.5,color="#3BBA76")+
  ggtitle('Inshore')
#net.rad.pre.uk1i
net.rad.pre.uk1o <- ggnet2(adj.rad.pre.uk1o,size=1,alpha=0.5,color="#453882")+
  ggtitle('Offshore')
#net.rad.pre.uk1o

ggarrange(net.rad.pre.uk1i,net.rad.pre.uk1o)

net.rad.irm.uk1i <- ggnet2(adj.rad.irm.uk1i,size=1,alpha=0.5,color="#3BBA76")+
  ggtitle(' ')
#net.rad.irm.uk1i
net.rad.irm.uk1o <- ggnet2(adj.rad.irm.uk1o,size=1,alpha=0.5,color="#453882")+
  ggtitle(' ')
#net.rad.irm.uk1o

ggarrange(net.rad.irm.uk1i,net.rad.irm.uk1o)            

net.rad.pos.uk1i <- ggnet2(adj.rad.pos.uk1i,size=1,alpha=0.5,color="#3BBA76")+
  ggtitle(' ')
#net.rad.pos.uk1i
net.rad.pos.uk1o <- ggnet2(adj.rad.pos.uk1o,size=1,alpha=0.5,color="#453882")+
  ggtitle(' ')
net.rad.pos.uk1o
...
```{r}
gg.net.uk1 <- ggarrange(net.rad.pre.uk1i,net.rad.pre.uk1o,net.rad.irm.uk1i,net.rad.irm.uk1o,net.rad.pos.uk1i,net.rad.pos.uk1o,ncol=2,nrow=3)

annotate_figure(gg.net.uk1,top=text_grob("S. raderea - Upper Keys 1",size=16))
```
...
#removed size.min=1 from options
net.rad.pre.uk2i <- ggnet2(adj.rad.pre.uk2i,size=1,alpha=0.5,color="#3BBA76")+
  ggtitle('Inshore')
#net.rad.pre.uk2i
net.rad.pre.uk2o <- ggnet2(adj.rad.pre.uk2o,size=1,alpha=0.5,color="#453882")+
  ggtitle('Offshore')
#net.rad.pre.uk2o

ggarrange(net.rad.pre.uk2i,net.rad.pre.uk2o)

net.rad.irm.uk2i <- ggnet2(adj.rad.irm.uk2i,size=1,alpha=0.5,color="#3BBA76")+
  ggtitle(' ')
#net.rad.irm.uk2i
net.rad.irm.uk2o <- ggnet2(adj.rad.irm.uk2o,size=1,alpha=0.5,color="#453882")+
  ggtitle(' ')
#net.rad.irm.uk2o

ggarrange(net.rad.irm.uk2i,net.rad.irm.uk2o)            

net.rad.pos.uk2i <- ggnet2(adj.rad.pos.uk2i,size=1,alpha=0.5,color="#3BBA76")+
  ggtitle(' ')
#net.rad.pos.uk2i
net.rad.pos.uk2o <- ggnet2(adj.rad.pos.uk2o,size=1,alpha=0.5,color="#453882")+
  ggtitle(' ')
net.rad.pos.uk2o
...
annotate_figure(gg.net.uk2,top=text_grob("S. raderea - Upper Keys 2",size=16))
```
