...
Note: I ended up doing the cohesion calculations on the cluster because the datasets were too large. The scripts here are the same as running locally on R. 
