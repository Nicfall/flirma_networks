...
```{r, eval=F}
ps.rare <- readRDS("../01.generate_asv_table/fl16s.23.ps.cleaner.rare5500.rds")
...
```{r}
#ps.rare <- readRDS("./nets_revised/ps.rare.asvsnamed.rds")

#ps.rare <- tax_glom(ps.rare1,taxrank="Family")
#saveRDS(ps.rare,file="./nets_revised/ps.rare.asvsnamed.fam.rds")
#ps.rare <- readRDS("./nets_revised/ps.rare.asvsnamed.fam.rds")

#ps.rare.gen <- tax_glom(ps.rare,taxrank="Genus")
#saveRDS(ps.rare.gen,file="./nets_revised/ps.rare.asvsnamed.genus.rds")
...
```{r}
ps.sid.trim <- phyloseq_filter_prevalence(ps.sid,abund.trh=55,prev.trh=0.25,threshold_condition="AND")
ps.sid.trim #139 taxa

##previous iteration notes:
#or maybe this one:
#113 at 0.2 prev, family level
#last try: asv.2
#81 out
#89 out at gen.25
#106 out at 0.2 prevalence
##probably not doing the rest:
#112 gen at 0.2 prevalence, without UK2 site
#194 out at 0.1 

#59 out at asv.25
#297 out at 0.1 prevalence, ASV level
#148 out at 0.15 prevalence, ASV level


#104 with genus, 20% prevalence
#182 with genus, 10% prevalence
#241 with ASV, 10% prev


#saveRDS(ps.sid.trim,file="./nets_revised/ps.sid.trim.rds")
#saveRDS(ps.rad.trim,file="./nets_revised/ps.rad.trim.rds")
...
```{r}
ps.rad.trim <- phyloseq_filter_prevalence(ps.rad,abund.trh=55,prev.trh=0.25,threshold_condition="AND")
ps.rad.trim #254 taxa
...
ps.rad.pre.no0 #222 taxa

ps.rad.irm.no0 <- prune_taxa(taxa_sums(ps.rad.irm) > 55, ps.rad.irm)
ps.rad.irm.no0 #200 taxa

ps.rad.pos.no0 <- prune_taxa(taxa_sums(ps.rad.pos) > 55, ps.rad.pos)
ps.rad.pos.no0 #137 taxa
```

```{r}
##ASV.2 level
# saveRDS(ps.sid.pre,file="./nets_revised/ps.sid.pre.asv.2")
# saveRDS(ps.sid.irm,file="./nets_revised/ps.sid.irm.asv.2")
# saveRDS(ps.sid.pos,file="./nets_revised/ps.sid.pos.asv.2")
# 
# saveRDS(ps.rad.pre,file="./nets_revised/ps.rad.pre.asv.2")
# saveRDS(ps.rad.irm,file="./nets_revised/ps.rad.irm.asv.2")
# saveRDS(ps.rad.pos,file="./nets_revised/ps.rad.pos.asv.2")

##others
# saveRDS(otu.sid.pre.trim,file="./nets_revised/otu.sid.pre.gen.1.rds")
# saveRDS(otu.sid.irm.trim,file="./nets_revised/otu.sid.irm.gen.1.rds")
# saveRDS(otu.sid.pos.trim,file="./nets_revised/otu.sid.pos.gen.1.rds")
#
# saveRDS(ps.sid.pre,file="./nets_revised/ps.sid.pre.gen.1")
# saveRDS(ps.sid.irm,file="./nets_revised/ps.sid.irm.gen.1")
# saveRDS(ps.sid.pos,file="./nets_revised/ps.sid.pos.gen.1")

# saveRDS(ps.sid.pre,file="./nets_revised/ps.sid.pre.fam.2")
# saveRDS(ps.sid.irm,file="./nets_revised/ps.sid.irm.fam.2")
# saveRDS(ps.sid.pos,file="./nets_revised/ps.sid.pos.fam.2")
# 
# saveRDS(ps.rad.pre,file="./nets_revised/ps.rad.pre.fam.2")
# saveRDS(ps.rad.irm,file="./nets_revised/ps.rad.irm.fam.2")
# saveRDS(ps.rad.pos,file="./nets_revised/ps.rad.pos.fam.2")

#saveRDS(otu.rad.pre.trim,file="./nets_revised/otu.rad.pre.gen.2.rds")
#saveRDS(otu.rad.irm.trim,file="./nets_revised/otu.rad.irm.gen.2.rds")
#saveRDS(otu.rad.pos.trim,file="./nets_revised/otu.rad.pos.gen.2.rds")

#saveRDS(ps.rad.pre,file="./nets_revised/ps.rad.pre.gen.2")
#saveRDS(ps.rad.irm,file="./nets_revised/ps.rad.irm.gen.2")
#saveRDS(ps.rad.pos,file="./nets_revised/ps.rad.pos.gen.2")
```
...
samdf.sid.pre <- data.frame(ps.sid.pre.no0@sam_data)
otu.sid.pre <- data.frame(ps.sid.pre.no0@otu_table)
...
##family.2 level
# Mantel statistic r: 0.1759 
#       Significance: 0.001 

##gen.2 data:
# Mantel statistic r: 0.1705 
#       Significance: 0.001 
##from gen.1 data:
# Mantel statistic r: 0.1798 
#       Significance: 0.001 
##asv 0.15 level
...
```{r}
#ps.sid.irm <- readRDS("./nets_revised/ps.sid.irm.gen.1")
#ps.sid.irm <- readRDS("./nets_revised/maybe not using/ps.sid.irm.gen.2")

samdf.sid.irm <- data.frame(ps.sid.irm.no0@sam_data)
otu.sid.irm <- data.frame(ps.sid.irm.no0@otu_table)
...
otu.geo.sid.irm
# Mantel statistic r: 0.06323 
#       Significance: 0.079 

##asv.2
# Mantel statistic r: 0.07632 
#       Significance: 0.052 
...
##from gen.1 data:
# Mantel statistic r: 0.09784 
#       Significance: 0.028 
##from asv.15 data:
# Mantel statistic r: 0.07287 
#       Significance: 0.056 
```
...
```{r}
#ps.sid.pos <- readRDS("./nets_revised/ps.sid.pos.gen.1")
samdf.sid.pos <- data.frame(ps.sid.pos.no0@sam_data)
otu.sid.pos <- data.frame(ps.sid.pos.no0@otu_table)
...
otu.geo.sid.pos
# Mantel statistic r: -0.0228 
#       Significance: 0.752 

##asv.2
# Mantel statistic r: -0.01208 
#       Significance: 0.532

##fam.2
# Mantel statistic r: -0.009064 
#       Significance: 0.477 

##from gen.1 data:
# Mantel statistic r: -0.02544 
#       Significance: 0.73 
# Mantel statistic r: -0.01777 
#       Significance: 0.609 
# Mantel statistic r: -0.009064 
#       Significance: 0.477 
```
...
```{r}
##transferring lat lon info to sample data frame
#ps.rad.pre <- readRDS("./nets_revised/ps.rad.pre.gen.1")
samdf.rad.pre <- data.frame(ps.rad.pre.no0@sam_data)
otu.rad.pre <- data.frame(ps.rad.pre.no0@otu_table)
...
```{r}
#ps.rad.irm <- readRDS("./nets_revised/ps.rad.irm.gen.1")
samdf.rad.irm <- data.frame(ps.rad.irm.no0@sam_data)
otu.rad.irm <- data.frame(ps.rad.irm.no0@otu_table)
...
# Mantel statistic r: 0.05536 
#       Significance: 0.123 

##from fam.2 data
# Mantel statistic r: 0.02359 
#       Significance: 0.252 
```
...
```{r}
#ps.rad.pos <- readRDS("./nets_revised/ps.rad.pos.gen.1")
samdf.rad.pos <- data.frame(ps.rad.pos.no0@sam_data)
otu.rad.pos <- data.frame(ps.rad.pos.no0@otu_table)
...
otu.geo.rad.pos
# Mantel statistic r: -0.03511 
#       Significance: 0.722 


##fam.2
# Mantel statistic r: -0.02001 
#       Significance: 0.613 
```

# Constructing networks

Stabilities: 0.042, 0.043, 0.047, 0.047, 0.045, 0.044
Stabilities 2023: 
...
#2023 run: 
#0.04388426 nlambda 40

##past iterations:
##trying fam.2, lambda30, 1e-1
#0.04227197

#0.0400 with lambda 30 with 0.2 prevalence
#0.0444 with lambda 20 with 0.1 prevalence
#0.0429 with nlambda 30, 1e-1
#ASV level: 0.04938818 nlambda 30, 1e-2
...
#2023 run: 
#0.04642047 nlambda 40

##trying fam.2, lambda30, 1e-1
#0.04254165

#0.0407 lambda 30 with 0.2 prevalence
#0.032 lambda 20 with 0.1 prevalence
#0.04944 with lambda 30, 1e-1
#ASV level: 0.0453915 nlambda 30, 1e-2
...
#2023 run: 
#0.04678715 nlambda 40

##trying fam.2, lambda30, 1e-1
#0.04672183

#0.033 with lambda 30 :/ same with 20.. on to 40
#40 was the best, 0.0486
#0.0487 with lambda 30, 1e-1
...
#saveRDS(se.sid.pre,file="./nets_revised/se.sid.pre.gen.25.rds")
#saveRDS(se.sid.irm,file="./nets_revised/se.sid.irm.gen.25.rds")
#saveRDS(se.sid.pos,file="./nets_revised/se.sid.pos.gen.25.rds")
```
...
#0.032 with lambda 30
#0.04321928 with lambda 20 
#fam.2: lambda 1e-1, 30
#0.04496291
...
#0.0305 with lambda 20
#0.0435 with lambda 30
#fam.2, lambda 30, 1e-1
#0.04364215
...
# saveRDS(se.rad.pre,file="./nets_revised/se.rad.pre.gen.25.rds")
# saveRDS(se.rad.irm,file="./nets_revised/se.rad.irm.gen.25.rds")
# saveRDS(se.rad.pos,file="./nets_revised/se.rad.pos.gen.25.rds")
```
...
rownames(sebeta.sid.pre) <- colnames(sebeta.sid.pre) <- taxa_names(ps.sid.pre.no0)
elist.sid.pre <- summary(sebeta.sid.pre)
emat.sid.pre <- data.frame(as.matrix(sebeta.sid.pre))

positive=length(emat.sid.pre[emat.sid.pre>0])/2 #141
negative=length(emat.sid.pre[emat.sid.pre<0])/2 #44
total=length(emat.sid.pre[emat.sid.pre!=0])/2 #185
...
ig.sid.pre <- adj2igraph(getRefit(se.sid.pre),diag=TRUE,
                  ...
                  vertex.attr=list(name=taxa_names(ps.sid.pre.no0)))
...
rownames(sebeta.sid.irm) <- colnames(sebeta.sid.irm) <- taxa_names(ps.sid.irm.no0)
elist.sid.irm <- summary(sebeta.sid.irm)
emat.sid.irm <- data.frame(as.matrix(sebeta.sid.irm))

positive=length(emat.sid.irm[emat.sid.irm>0])/2 #148
negative=length(emat.sid.irm[emat.sid.irm<0])/2 #53 
total=length(emat.sid.irm[emat.sid.irm!=0])/2 #201
...
ig.sid.irm <- adj2igraph(getRefit(se.sid.irm),diag=TRUE,
                  ...
                  vertex.attr=list(name=taxa_names(ps.sid.irm.no0)))
...
rownames(sebeta.sid.pos) <- colnames(sebeta.sid.pos) <- taxa_names(ps.sid.pos.no0)
elist.sid.pos <- summary(sebeta.sid.pos)
emat.sid.pos <- data.frame(as.matrix(sebeta.sid.pos))

positive=length(emat.sid.pos[emat.sid.pos>0])/2 #120
negative=length(emat.sid.pos[emat.sid.pos<0])/2 #50
total=length(emat.sid.pos[emat.sid.pos!=0])/2 #170
...
ig.sid.pos <- adj2igraph(getRefit(se.sid.pos),diag=TRUE,
                  ...
                  vertex.attr=list(name=taxa_names(ps.sid.pos.no0)))
...
rownames(sebeta.rad.pre) <- colnames(sebeta.rad.pre) <- taxa_names(ps.rad.pre.no0)
elist.rad.pre <- summary(sebeta.rad.pre)
emat.rad.pre <- data.frame(as.matrix(sebeta.rad.pre))

positive=length(emat.rad.pre[emat.rad.pre>0])/2 #336
negative=length(emat.rad.pre[emat.rad.pre<0])/2 #141
total=length(emat.rad.pre[emat.rad.pre!=0])/2 #477
# We divide by two since an edge is represented by two entries in the matrix.

ig.rad.pre <- adj2igraph(getRefit(se.rad.pre),diag=TRUE,
                  edge.attr=elist.rad.pre,
                  vertex.attr=list(name=taxa_names(ps.rad.pre.no0)))
...
rownames(sebeta.rad.irm) <- colnames(sebeta.rad.irm) <- taxa_names(ps.rad.irm.no0)
elist.rad.irm <- summary(sebeta.rad.irm)
emat.rad.irm <- data.frame(as.matrix(sebeta.rad.irm))

positive=length(emat.rad.irm[emat.rad.irm>0])/2 #295
negative=length(emat.rad.irm[emat.rad.irm<0])/2 #108
total=length(emat.rad.irm[emat.rad.irm!=0])/2 #403
# We divide by two since an edge is reirmsented by two entries in the matrix.

ig.rad.irm <- adj2igraph(getRefit(se.rad.irm),diag=TRUE,
                  edge.attr=elist.rad.irm,
                  vertex.attr=list(name=taxa_names(ps.rad.irm.no0)))
...
rownames(sebeta.rad.pos) <- colnames(sebeta.rad.pos) <- taxa_names(ps.rad.pos.no0)
elist.rad.pos <- summary(sebeta.rad.pos)
emat.rad.pos <- data.frame(as.matrix(sebeta.rad.pos))

positive=length(emat.rad.pos[emat.rad.pos>0])/2 #120
negative=length(emat.rad.pos[emat.rad.pos<0])/2 #49
total=length(emat.rad.pos[emat.rad.pos!=0])/2 #169
# We divide by two since an edge is repossented by two entries in the matrix.

ig.rad.pos <- adj2igraph(getRefit(se.rad.pos),diag=TRUE,
                  edge.attr=elist.rad.pos,
                  vertex.attr=list(name=taxa_names(ps.rad.pos.no0)))
...
```{r}
transitivity(ig.sid.pre,type = "globalundirected") #0.1105048
transitivity(ig.sid.irm,type = "globalundirected") #0.1598639
transitivity(ig.sid.pos,type = "globalundirected") #0.101072

transitivity(ig.rad.pre,type = "globalundirected") #0.1022727
transitivity(ig.rad.irm,type = "globalundirected") #0.122588
transitivity(ig.rad.pos,type = "globalundirected") #0.1062992
 
transitivity(ig.sid.pre,type = "average") #0.1867429
transitivity(ig.sid.irm,type = "average") #0.1967393
transitivity(ig.sid.pos,type = "average") #0.09976294

transitivity(ig.rad.pre,type = "average") #0.1055028
transitivity(ig.rad.irm,type = "average") #0.1167073
transitivity(ig.rad.pos,type = "average") #0.1245581
...
ggplot(tran.sid,aes(x=time,y=log(tran)))+
  geom_boxplot()
####clean up? show####

pairwise.wilcox.test(tran.sid$tran,tran.sid$time,p.adjust.method = "BH")

kruskal.test(log(tran)~time,data=tran.sid)
...
ggplot(tran.rad,aes(x=time,y=log(tran)))+
  geom_boxplot()

kruskal.test(log(tran)~time,data=tran.rad)
...
kruskal.test(deg~time,data=deg.rad)
```

### Saving all

```{r}
#saveRDS(ig.sid.pre,file="./nets_revised/ig.sid.pre.gen.25.rds")
#saveRDS(ig.sid.irm,file="./nets_revised/ig.sid.irm.gen.25.rds")
#saveRDS(ig.sid.pos,file="./nets_revised/ig.sid.pos.gen.25.rds")

#saveRDS(ig.rad.pre,file="./nets_revised/ig.rad.pre.gen.25.rds")
#saveRDS(ig.rad.irm,file="./nets_revised/ig.rad.irm.gen.25.rds")
#saveRDS(ig.rad.pos,file="./nets_revised/ig.rad.pos.gen.25.rds")
```
...
deg.rad.pre$num2 <- deg.rad.pre$num/221
...
deg.rad.irm$num2 <- deg.rad.irm$num/199
...
deg.rad.pos$num2 <- deg.rad.pos$num/136
...
deg.sid.pre$num2 <- deg.sid.pre$num/132
...
deg.sid.irm$num2 <- deg.sid.irm$num/133
...
deg.sid.pos$num2 <- deg.sid.pos$num/126
...
```{r}
ig.sid.pre <- readRDS("./nets_revised/ig.sid.pre.gen.25.rds")
ig.sid.irm <- readRDS("./nets_revised/ig.sid.irm.gen.25.rds")
ig.sid.pos <- readRDS("./nets_revised/ig.sid.pos.gen.25.rds")

ig.rad.pre <- readRDS("./nets_revised/ig.rad.pre.gen.25.rds")
ig.rad.irm <- readRDS("./nets_revised/ig.rad.irm.gen.25.rds")
ig.rad.pos <- readRDS("./nets_revised/ig.rad.pos.gen.25.rds")
```
