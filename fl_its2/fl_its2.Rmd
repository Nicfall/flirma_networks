...
# ps.rad.pre.lk1.rel.zone <- transform_sample_counts(ps.rad.pre.lk1.rel.zone, function(x) x / sum(x))
# 
# plot_bar(ps.rad.pre.lk1.rel.zone, fill="Clade")

#remove uk3
ps.rad.gen.pre <- subset_samples(ps.rad.gen.pre,site!="UK3")
...
#remove uk3
ps.sid.pre <- subset_samples(ps.sid.pre,site!="UK3")
