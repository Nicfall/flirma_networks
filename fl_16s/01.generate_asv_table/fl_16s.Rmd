...
ps
#72110, 320 samples
sum(sample_sums(ps)) #15,222,260 raw reads
...
ps.chlor #503 taxa to remove
ps.notbact <- subset_taxa(ps, (domain!="Bacteria") | is.na(domain))
ps.notbact #22412 taxa to remove
...
ps.trim #7423 taxa and 316 samples
