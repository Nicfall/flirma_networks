...
ps.sid.pre.rel.sz <- transform_sample_counts(ps.sid.pre.rel.sz, function(x) x / sum(x))

gg.bar.pre <- plot_bar(ps.sid.pre.rel.sz, fill="Majority_ITS2_sequence")+
    ggtitle("Pre")+
    theme_cowplot()+
    theme(axis.text.x=element_text(angle=90,hjust=1))+
    xlab("")
...
ps.sid.irm.rel.sz <- transform_sample_counts(ps.sid.irm.rel.sz, function(x) x / sum(x))

gg.bar.irm <- plot_bar(ps.sid.irm.rel.sz, fill="Majority_ITS2_sequence")+
    ggtitle("Irma")+
    theme_cowplot()+
    theme(axis.text.x=element_text(angle=90,hjust=1))+
    xlab("")
...
ps.sid.pos.rel.sz <- transform_sample_counts(ps.sid.pos.rel.sz, function(x) x / sum(x))

gg.bar.pos <- plot_bar(ps.sid.pos.rel.sz, fill="Majority_ITS2_sequence3")+
    ggtitle("Post")+
    theme_cowplot()+
    theme(axis.text.x=element_text(angle=90,hjust=1))+
    xlab("")
